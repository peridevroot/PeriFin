...
contract PeriFinEscrow is Owned, LimitedSetup(8 weeks), IHasBalance {
    ...
    /* An account's total vested perifin balance to save recomputing this for fee extraction purposes. */
    mapping(address => uint) public totalVestedAccountBalance;

    /* The total remaining vested balance, for verifying the actual perifin balance of this contract against. */
    ...
    constructor(address _owner, IPeriFin _perifin) public Owned(_owner) {
        perifin = _perifin;
    }
     ...
     * in this contract, or a corresponding call to perifin.endow(), to ensure that when
    ...
    function appendVestingEntry(
        ...
        require(
            totalVestedBalance <= IERC20(address(perifin)).balanceOf(address(this)),
