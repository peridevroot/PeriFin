...
contract EmptyCollateralManager is ICollateralManager {
    ...
    function isPynthManaged(bytes32) external view returns (bool) {
        return false;
    }
    ...
    function arePynthsAndCurrenciesSet(bytes32[] calldata, bytes32[] calldata) external view returns (bool) {
        return false;
    }

    function areShortablePynthsSet(bytes32[] calldata, bytes32[] calldata) external view returns (bool) {
        return false;
    }
    ...
    function addPynths(bytes32[] calldata, bytes32[] calldata) external {}
