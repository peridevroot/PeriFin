...
contract BaseRewardEscrowV2 is Owned, IRewardEscrowV2, LimitedSetup(8 weeks), MixinResolver {
    ...
    function resolverAddressesRequired() public view returns (bytes32[] memory addresses) {
        ...
        addresses[0] = CONTRACT_PYNTHETIX;
    ...
    function createEscrowEntry(
        ...
        require(IERC20(address(perifin())).transferFrom(msg.sender, address(this), deposit), "token transfer failed");
    ...
    function _transferVestedTokens(address _account, uint256 _amount) internal {
        ...
        IERC20(address(perifin())).transfer(_account, _amount);
