...
contract PurgeablePynth is Pynth {
    ...
    // The maximum allowed amount of tokenSupply in equivalent pUSD value for this pynth to permit purging
    ...
    function purge(address[] calldata addresses) external optionalProxy_onlyOwner {
        ...
        uint maxSupplyToPurge = exRates.effectiveValue("pUSD", maxSupplyToPurgeInUSD, currencyKey);
