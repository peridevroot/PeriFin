...
contract RewardEscrowV2 is BaseRewardEscrowV2 {
    ...
    bytes32 private constant CONTRACT_PYNTHETIX_BRIDGE_OPTIMISM = "PeriFinBridgeToOptimism";
    ...
    function resolverAddressesRequired() public view returns (bytes32[] memory addresses) {
        ...
        newAddresses[0] = CONTRACT_PYNTHETIX_BRIDGE_OPTIMISM;
    ...
    function perifinBridgeToOptimism() internal view returns (address) {
        return requireAndGetAddress(CONTRACT_PYNTHETIX_BRIDGE_OPTIMISM);
    }
    ...
    function migrateAccountEscrowBalances(
        ...
        for (uint i = 0; i < accounts.length; i++) {
            ...
            /* Update totalEscrowedBalance for tracking the PeriFin balance of this contract. */
        ...
        returns (uint256 escrowedAccountBalance, VestingEntries.VestingEntry[] memory vestingEntries)
    {
        ...
        if (escrowedAccountBalance > 0) {
            ...
            IERC20(address(perifin())).transfer(perifinBridgeToOptimism(), escrowedAccountBalance);
        }
    ...
    modifier onlyPeriFinBridge() {
        require(msg.sender == perifinBridgeToOptimism(), "Can only be invoked by PeriFinBridgeToOptimism contract");
        _;
    }
