...
contract EtherCollateral is Owned, Pausable, ReentrancyGuard, MixinResolver, IEtherCollateral {
    ...
    bytes32 private constant CONTRACT_PYNTHSETH = "PynthpETH";
    ...
    function resolverAddressesRequired() public view returns (bytes32[] memory addresses) {
        ...
        addresses[1] = CONTRACT_PYNTHSETH;
        addresses[2] = CONTRACT_PYNTHSUSD;
    ...
    function pynthpETH() internal view returns (IPynth) {
        return IPynth(requireAndGetAddress(CONTRACT_PYNTHSETH));
    }
