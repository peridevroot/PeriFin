...
contract PeriFinState is Owned, State, LimitedSetup, IPeriFinState {
    ...
    // /**
    //  * @notice Import issuer data from the old PeriFin contract before multicurrency
    ...
    //     // Note: this function's implementation has been removed from the current PeriFin codebase
    ...
    //     // For the previous implementation, see PeriFin._addToDebtRegister()
    // }
